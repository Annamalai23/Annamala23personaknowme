...
const socials = [
  {
    label: "LinkedIn",
    handle: "@annamalai-r",
    href: "https://www.linkedin.com/in/annamalai-r-6b5a883a2/",
    icon: (
  ...
  },
  {
    label: "YouTube",
    handle: "@annamalai-ai",
    href: "https://youtube.com/@annamalai-ai",
    icon: (
      <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg">
...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Annamalai Raghupathy" },
      {
        name: "description",
        content:
          "AI engineering, agentic AI, and Azure data platform enquiries. Feel free to reach out.",
      },
      { property: "og:title", content: "Contact — Annamalai Raghupathy" },
      {
...
function ContactPage() {
  ...
  return (
    <AppShell>
      <PageHeader
        title="Contact"
        subtitle="AI engineering, agentic AI, and Azure data platform enquiries. Feel free to reach out."
      />
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_280px] items-start">
          ...
          <form onSubmit={submit} className="space-y-5">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <span className="font-mono text-xs text-muted-foreground">
                ...
                {status === "idle" && "Ready for transmission (requires RESEND_API_KEY env)..."}
              </span>
              <Button
                variant="primary"
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-border bg-card p-5">
            ...
            <a
              href="mailto:annaraghu2308@gmail.com"
          ...
          <div className="rounded-lg border border-border bg-card px-5 py-4 font-mono text-xs">
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <span>open to discuss AI & engineering opportunities</span>
            </div>
          </div>
        </div>
      </div>
